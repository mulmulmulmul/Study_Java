 ...
 * [최은지]===================================================================
 *
 * ArrayStack 생성자 매개변수에 string이 필요하지 않습니다.
 * 
 * 메인 메소드 내 for문을 이용하여 배열의 값을 출력하는 것이 아니라
 * 클래스의 push 메소드를 이용해 저장한 값을 차례대로 (증가식++ 이용)출력합니다. 
 *
 * pop 메소드는 반대로 값을 꺼내 리턴하는 과정의 코드작성이 필요합니다.
 * 
 *==============================================================================
 */
//		[메서드 정의]
